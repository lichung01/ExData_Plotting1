...
# Open PNG device (size 480 by 480) and create file "plot2.png" in my working directory.
png(filename = "plot2.png", width = 480, height = 480, units = "px", bg = "transparent")

# Plot the chart
with(data, plot(dateTimeVar, Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)"))
